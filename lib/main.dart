...
Map<String,_Country> _getData() {
 ...
 lookupAreaCode(Map<String,_Country> countries, String data) {
    Map countryMap = jsonDecode(data);
    countryMap.forEach((key, value) {
      if (!countries.containsKey(key)){
        var country = _Country();
  ...
  lookupCapital(Map<String,_Country> countries, String data) {
    Map countryMap = jsonDecode(data);
    countryMap.forEach((key, value) {
      if (!countries.containsKey(key)){
        var country = _Country();
   ...
   lookupCountry(Map<String,_Country> countries, String data) {
    Map countryMap = jsonDecode(data);
    countryMap.forEach((key, value) {
      if (!countries.containsKey(key)){
        var country = _Country();
  ...
  lookupIOS3(Map<String,_Country> countries,String data) {
    Map countryMap = jsonDecode(data);
    countryMap.forEach((key, value) {
      if (!countries.containsKey(key)){
        var country = _Country();
  ...
  void initState() {
    super.initState();
    this._counties = _getData();
  }

  _click(bool value, _Country county){
    print(value);
